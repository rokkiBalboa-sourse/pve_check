...
echo -e "  \033[0;32m1)\033[0m GitHub (основной, требует интернета)"
echo -e "  \033[0;32m2)\033[0m Yandex.Disk (зеркало, для закрытых сетей)"
echo ""
...
if [[ "$choice" == "1" ]]; then
    ...
    if command -v git &> /dev/null; then
        ...
        echo -e "\033[1;33m[!] Git не установлен. Скачивание файлов поштучно...\033[0m"
